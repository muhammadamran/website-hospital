	...
	<main id="main">
		...
		<section id="breadcrumbs" class="breadcrumbs">
			<div class="container">
				...
				<h2>Alur Pelayanan Radiologi</h2>
			</div>
		</section>
		<!-- ======= Blog Section ======= -->
				...
				<div class="row">
					<div class="col-lg-8 entries">
						<article class="entry entry-single">
						    ...
						    $result = mysqli_query($con,"SELECT * FROM tb_alurradiologi WHERE status='SHOW' AND berkas IS NULL ORDER BY id DESC");
							...
							?>
							<?php
							if ($row['alur_radiologi']==NULL) {
							?>
								<img src="<?php echo base_url('assets/images/empty/img-empty.png');?>" alt="" class="img-fluid">
							<?php
							}else{
							?>
								<img src="<?php echo base_url('assets/images/rumah-sakit/radiologi/alur/'.$row['alur_radiologi']);?>" alt="" class="img-fluid">
							<?php } ?>
						    ...
						    if(mysqli_num_rows($result)>0){
						        ...
						        {
							?>
							<?php echo $row['isi_alurradiologi']; ?>
							<?php } } mysqli_close($con); ?>
							</div>
						...
						<div class="sidebar">
							...
							<div class="sidebar-item categories">
								<ul>
									...
									<li><a href="<?php echo base_url()."index.php/WebPenunjangMedis/indexAlurRadiologi";?>"><font style="color: #28a745">Alur Pelayanan Radiologi </font></a></li>
								</ul>
							</div>
							...
							<div class="sidebar-item categories">
								<ul>
									...
									<li><a href="<?php echo base_url()."index.php/WebPenunjangMedis/indexLab";?>">Laboratoirum </a></li>
