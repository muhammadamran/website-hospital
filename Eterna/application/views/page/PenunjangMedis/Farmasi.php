				...
				<div class="row">
					<div class="col-lg-8 entries">
						<article class="entry entry-single">
						    ...
						    $result = mysqli_query($con,"SELECT * FROM tb_farmasi WHERE status='SHOW' AND berkas IS NULL ORDER BY id DESC");
							...
							?>
								<img src="<?php echo base_url('assets/images/rumah-sakit/farmasi/'.$row['link_farmasi']);?>" alt="" class="img-fluid">
							<?php } ?>
						    ...
						    if(mysqli_num_rows($result)>0){
						        ...
						        {
							?>
								<a href=""><?php echo $row['judul_farmasi']; ?></a>
							<?php } } mysqli_close($con); ?>
							</h2>
					...
					<div class="col-lg-4">
						<div class="sidebar">
							...
							<div class="sidebar-item categories">
								<ul>
									<li><a href="<?php echo base_url()."index.php/WebPenunjangMedis/indexFarmasi";?>"><font style="color: #28a745">Farmasi </font></a></li>
