	...
	<main id="main">
		...
		<section id="breadcrumbs" class="breadcrumbs">
			<div class="container">
				...
				<h2>Alur Pelayanan Instalasi Rawat Jalan</h2>
			</div>
		</section>
		<!-- ======= Blog Section ======= -->
				...
				<div class="row">
					<div class="col-lg-8 entries">
						<article class="entry entry-single">
						    ...
						    $result = mysqli_query($con,"SELECT * FROM tb_alurrj WHERE status='SHOW' AND berkas IS NULL ORDER BY id DESC");
							...
							?>
								<img src="<?php echo base_url('assets/images/rumah-sakit/rawat-jalan/alur/'.$row['alur_rj']);?>" alt="" class="img-fluid">
							<?php } ?>
							...
							<div class="entry-footer clearfix">
								<div class="float-left">
									...
									<ul class="tags">
										<li><a href="#">Alur Pelayanan Instalasi Rawat Jalan</a></li>
									</ul>
								</div>
						...
						<div class="sidebar">
							...
							<div class="sidebar-item categories">
								<ul>
									...
									<li><a href="<?php echo base_url()."index.php/WebPelayananMedis/indexAlurRJ";?>"><font style="color: #28a745">Alur Pelayanan Instalasi Rawat Jalan</font></a></li>
