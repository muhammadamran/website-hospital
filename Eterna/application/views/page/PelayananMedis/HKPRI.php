	...
	<main id="main">
		...
		<section id="breadcrumbs" class="breadcrumbs">
			<div class="container">
				...
				<h2>Hak & Kewajiban Pasien Rawat Inap</h2>
			</div>
		</section>
		<!-- ======= Blog Section ======= -->
				...
				<div class="row">
					<div class="col-lg-8 entries">
						<article class="entry entry-single">
						    ...
						    $result = mysqli_query($con,"SELECT * FROM tb_hkpri WHERE status='SHOW' AND berkas IS NULL ORDER BY id DESC");
							...
							?>
								<img src="<?php echo base_url('assets/images/rumah-sakit/rawat-inap/hak-kewajiban/'.$row['link_hkpri']);?>" alt="" class="img-fluid">
							<?php } ?>
							...
							<div class="entry-footer clearfix">
								<div class="float-left">
									...
									<ul class="tags">
										<li><a href="#">Hak & Kewajiban Pasien Rawat Inap</a></li>
									</ul>
								</div>
						...
						<div class="sidebar">
							...
							<div class="sidebar-item categories">
								<ul>
									...
									<li><a href="<?php echo base_url()."index.php/WebPelayananMedis/indexAlurRI";?>">Alur Pelayanan Instalasi Rawat Inap</a></li>
									...
									<li><a href="<?php echo base_url()."index.php/WebPelayananMedis/indexHKPRI";?>"><font style="color: #28a745">Hak & Kewajiban Pasien Rawat Inap</font></a></li>
								</ul>
							</div>
