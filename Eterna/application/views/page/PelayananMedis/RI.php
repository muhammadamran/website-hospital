				...
				<div class="row">
					<div class="col-lg-8 entries">
						<article class="entry entry-single">
						    ...
						    $result = mysqli_query($con,"SELECT * FROM tb_ri WHERE status='SHOW' AND berkas IS NULL ORDER BY id DESC");
							...
							?>
								<img src="<?php echo base_url('assets/images/rumah-sakit/rawat-inap/'.$row['link_ri']);?>" alt="" class="img-fluid">
							<?php } ?>
						    ...
						    if(mysqli_num_rows($result)>0){
						        ...
						        {
							?>
								<a href=""><?php echo $row['judul_ri']; ?></a>
							<?php } } mysqli_close($con); ?>
							</h2>
