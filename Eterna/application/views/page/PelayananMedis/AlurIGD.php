	...
	<main id="main">
		...
		<section id="breadcrumbs" class="breadcrumbs">
			<div class="container">
				...
				<h2>Alur Pelayanan Instalasi Gawat Darurat</h2>
			</div>
		</section>
		<!-- ======= Blog Section ======= -->
				...
				<div class="row">
					<div class="col-lg-8 entries">
						<article class="entry entry-single">
						    ...
						    $result = mysqli_query($con,"SELECT * FROM tb_alurigd WHERE status='SHOW' AND berkas IS NULL ORDER BY id DESC");
							...
							?>
								<img src="<?php echo base_url('assets/images/rumah-sakit/igd/alur/'.$row['alur_igd']);?>" alt="" class="img-fluid">
							<?php } ?>
							...
							<div class="entry-footer clearfix">
								<div class="float-left">
									...
									<ul class="tags">
										<li><a href="#">Alur Pelayanan Instalasi Gawat Darurat</a></li>
									</ul>
								</div>
						...
						<div class="sidebar">
							...
							<div class="sidebar-item categories">
								<ul>
									...
									<li><a href="<?php echo base_url()."index.php/WebPelayananMedis/indexAlurIGD";?>"><font style="color: #28a745">Alur Pelayanan Instalasi Gawat Darurat (IGD) </font></a></li>
								</ul>
							</div>
