				...
				<div class="row">
					<div class="col-lg-8 entries">
						<article class="entry entry-single">
						    ...
						    $result = mysqli_query($con,"SELECT * FROM tb_alurbedah WHERE status='SHOW' AND berkas IS NULL ORDER BY id DESC");
							...
							?>
							<?php
							if ($row['alur_bedah']==NULL) {
							?>
								<img src="<?php echo base_url('assets/images/empty/img-empty.png');?>" alt="" class="img-fluid">
							<?php
							}else{
							?>
								<img src="<?php echo base_url('assets/images/rumah-sakit/pelayanan-bedah/alur/'.$row['alur_bedah']);?>" alt="" class="img-fluid">
							<?php } ?>
					...
					<div class="col-lg-4">
						<div class="sidebar">
							...
							<div class="sidebar-item categories">
								<ul>
									<li><a href="<?php echo base_url()."index.php/WebPelayananMedis/indexBedah";?>">Pelayanan Bedah</a></li>
									<li><a href="<?php echo base_url()."index.php/WebPelayananMedis/indexAlurBedah";?>"><font style="color: #28a745">Alur Pelayanan Bedah</font></a></li>
								</ul>
							</div>
							...
							<div class="sidebar-item categories">
								<ul>
									...
									<li><a href="<?php echo base_url()."index.php/WebPelayananMedis/indexBedah";?>"><font style="color: #28a745">Pelyanan Bedah</font></a></li>
