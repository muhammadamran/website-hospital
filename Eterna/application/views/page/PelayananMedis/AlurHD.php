	...
	<main id="main">
		...
		<section id="breadcrumbs" class="breadcrumbs">
			<div class="container">
				...
				<h2>Alur Pelayanan Hemodialisa</h2>
			</div>
		</section>
		<!-- ======= Blog Section ======= -->
						...
						<article class="entry entry-single">
							...
							<div class="entry-footer clearfix">
								<div class="float-left">
									...
									<ul class="tags">
										<li><a href="#">Alur Pelayanan Hemodialisa</a></li>
									</ul>
								</div>
						...
						<div class="sidebar">
							...
							<div class="sidebar-item categories">
								<ul>
									...
									<li><a href="<?php echo base_url()."index.php/WebPelayananMedis/indexHD";?>"><font style="color: #28a745">Alur Pelayanan Hemodialisa </font></a></li>
							...
							<div class="sidebar-item categories">
								<ul>
									<li><a href="<?php echo base_url()."index.php/WebPelayananMedis/indexHD";?>"><font style="color: #28a745">Hemodialisa & CAPD </font></a></li>
