				...
				<div class="row">
					<div class="col-lg-8 entries">
						<article class="entry entry-single">
						    ...
						    $result = mysqli_query($con,"SELECT * FROM tb_ttri WHERE status='SHOW' AND berkas IS NULL ORDER BY id DESC");
							...
							?>
								<img src="<?php echo base_url('assets/images/rumah-sakit/rawat-inap/tata-tertib/'.$row['link_ttri']);?>" alt="" class="img-fluid">
							<?php } ?>
						...
						<div class="sidebar">
							...
							<div class="sidebar-item categories">
								<ul>
									...
									<li><a href="<?php echo base_url()."index.php/WebPelayananMedis/indexTTRI";?>"><font style="color: #28a745">Tata Tertib Rawat Inap</font></a></li>
