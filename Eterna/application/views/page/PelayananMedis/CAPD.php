				...
				<div class="row">
					<div class="col-lg-8 entries">
						<article class="entry entry-single">
						    ...
						    $result = mysqli_query($con,"SELECT * FROM tb_capd WHERE status='SHOW' AND berkas IS NULL ORDER BY id DESC");
							...
							?>
								<img src="<?php echo base_url('assets/images/rumah-sakit/capd/'.$row['link_capd']);?>" alt="" class="img-fluid">
							<?php } ?>
						    ...
						    if(mysqli_num_rows($result)>0){
						        ...
						        {
							?>
								<a href=""><?php echo $row['judul_capd']; ?></a>
							<?php } } mysqli_close($con); ?>
							</h2>
						...
						<div class="sidebar">
							...
							<div class="sidebar-item categories">
								<ul>
									...
									<li><a href="<?php echo base_url()."index.php/WebPelayananMedis/indexAlurCAPD";?>">Alur Pelayanan CAPD</a></li>
								</ul>
							</div>
