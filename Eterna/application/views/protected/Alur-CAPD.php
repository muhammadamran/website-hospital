...
<body>
	...
	<div id="page-container" class="fade in page-sidebar-fixed page-header-fixed">
		<div id="content" class="content">
			...
			<h1 class="page-header">Pelayanan Medis - Alur CAPD</h1>
			<hr>
			<!-- MODAL ADD -->
				...
				<div class="modal-dialog modal-xl">
					<div class="modal-content">
						<div class="modal-header">
							<label class="modal-title">Add Alur CAPD</label>
							<button type="button" class="close" data-dismiss="modal" aria-label="Close">
								<span aria-hidden="true">&times;</span>
							</button>
						</div>
						<form method="POST" action="<?php echo base_url() ?>index.php/AdminPelayananMedis/createalurcapd" enctype="multipart/form-data">
							<div class="modal-body">
								<div class="row">	
									<div class="col-sm-12">
										<div class="form-group">
											<label>Code</label>
											<input type="text" class="form-control" name="kode" value="A-CAPD<?php echo date('YmdHis') ?>" readonly="readonly">
									...
									<div class="col-sm-12">
										<div class="form-group">
											<label>Gambar Alur CAPD<font style="color: red">*</font></label>
											<input type="file" class="form-control" name="alur_capd" required="required">
										</div>
									</div>	
									<div class="col-sm-12">
										<div class="form-group">
											<label>Isi Content Alur CAPD</label>
											<textarea class="ckeditor" id="ckedtor" name="isi_alurcapd" placeholder="Isi Content Alur CAPD..."></textarea>
										</div>
									</div>
								</div>
							</div>
				...
				<div class="col-xl-12">
					<div class="panel panel-inverse">
						<div class="panel-heading">
							<h4 class="panel-title">Table - Alur CAPD</h4>
							<button class="btn bg-info btn-flat" data-toggle="modal" data-target="#modal-add" title="Tambah Agenda Rapat"><i class="nav-icon far fa-plus-square"></i> Add Alur CAPD
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
						...
						<div class="panel-body">
							<table id="data-table-buttons" class="table table-striped table-bordered table-td-valign-middle">
								...
								<tbody>
									...
									$result = mysqli_query($con,"SELECT * FROM tb_alurcapd WHERE berkas IS NULL ORDER BY id DESC");
										...
										while($row = mysqli_fetch_array($result))
										{
											...
											<div class="modal fade" id="detail<?php echo $row['id'];?>" role="dialog">
												<div class="modal-dialog modal-xl">
													<div class="modal-content">
														<div class="modal-header">
															<label class="modal-title">Details Alur CAPD</label>
															<button type="button" class="close" data-dismiss="modal" aria-label="Close">
																<span aria-hidden="true">&times;</span>
															</button>
														</div>
														<div class="modal-body">
															<div class="row">
																<div class="col-sm-12">
																	<div align="center">
																		<h5>Gambar Alur CAPD</h5>
																		<hr>
																		<?php
																		if ($row['alur_capd']==NULL) { ?>
																			<h6><font style="color: red"><b><i>Anda belum mengupload Gambar Alur CAPD</i></b></font></h6>
																		<?php }else{ ?>
																			<img src="<?php echo base_url().'assets/images/rumah-sakit/capd/alur/'. $row['alur_capd'];?>" class="lingkaran3" alt="User profile picture">   
																		<?php } ?>
																	</div>
																</div>
																<hr>
																<div class="col-sm-12">
																	<div class="form-group">
																		<label>Isi</label>
																		<textarea class="ckeditor" id="ckedtor" name="isi_alurcapd" placeholder="Isi..."><?php echo $row['isi_alurcapd'];?></textarea>
																	</div>
																</div>
															</div>
															<div class="form-group">
											...
											<div class="modal fade" id="gambar<?php echo $row['id'];?>" role="dialog">
												<div class="modal-dialog modal-xl">
													<div class="modal-content">
														...
														<?php echo form_open_multipart(site_url('AdminPelayananMedis/updategambaralurcapd/'.$row['id']));?>
														<div class="modal-body">
															<div class="row">
																<div class="col-sm-12">
																	<div align="center">
																...
																<div class="col-sm-12">
																	<div class="form-group">
																		<label>Gambar Alur CAPD</label>
																		<input type="file" class="form-control" name="alur_capd" value="<?php echo $row['alur_capd'];?>">
																		<input type="hidden" class="form-control" name="id" value="<?php echo $row['id'];?>">
																	</div>
																</div>
															</div>
															<div class="form-group">
																<button type="submit" name="updategambaralurcapd" class="btn btn-block btn-primary">Update</button>
																<button type="button" class="btn btn-block btn-warning" data-dismiss="modal">Close</button>
															</div>
														</div>
													</form>
											...
											<div class="modal fade" id="isi<?php echo $row['id'];?>" role="dialog">
												<div class="modal-dialog modal-xl">
													<div class="modal-content">
														<div class="modal-header">
															<label class="modal-title">Update Isi Alur CAPD</label>
															<button type="button" class="close" data-dismiss="modal" aria-label="Close">
																<span aria-hidden="true">&times;</span>
															</button>
														</div>
														<?php echo form_open_multipart(site_url('AdminPelayananMedis/updateisialurcapd/'.$row['id']));?>
														<div class="modal-body">
															<div class="row">
																<div class="col-sm-12">
																	<div class="form-group">
															...
															<div class="form-group">
																<button type="submit" name="updateisialurcapd" class="btn btn-block btn-primary">Update</button>
																<button type="button" class="btn btn-block btn-warning" data-dismiss="modal">Close</button>
															</div>
														</div>
													</form>
											...
											<div class="modal fade" id="delete<?php echo $row['id'];?>" role="dialog">
												<div class="modal-dialog">
													<div class="modal-content">
														...
														<div class="modal-body">
															<?php echo form_open_multipart(site_url('AdminPelayananMedis/deletealurcapd/'.$row['id'])); ?>
															<div class="form-group">
															...
															<button type="submit" name="deletealurcapd" class="btn btn-danger btn-block btn-flat">Yes
															</button>
											...
											<div class="modal fade" id="hidden<?php echo $row['id'];?>" role="dialog">
												<div class="modal-dialog modal-xl">
													<div class="modal-content">
														...
														<?php echo form_open_multipart(site_url('AdminPelayananMedis/updatehiddenalurcapd/'.$row['id']));?>
														<div class="modal-body">
															<div class="row">
																<div class="col-sm-12">
																	<div class="form-group">
															...
															<div class="form-group">
																<button type="submit" name="updatehiddenalurcapd" class="btn btn-block btn-primary">Yes</button>
											...
											<div class="modal fade" id="show<?php echo $row['id'];?>" role="dialog">
												<div class="modal-dialog modal-xl">
													<div class="modal-content">
														...
														<?php echo form_open_multipart(site_url('AdminPelayananMedis/updateshowalurcapd/'.$row['id']));?>
														<div class="modal-body">
															<div class="row">
																<div class="col-sm-12">
																	<div class="form-group">
															...
															<div class="form-group">
																<button type="submit" name="updateshowalurcapd" class="btn btn-block btn-primary">Yes</button>
																<button type="button" class="btn btn-block btn-warning" data-dismiss="modal">No</button>
															</div>
														</div>
													</form>
