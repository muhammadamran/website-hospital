				...
				<div class="row">
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
						<div class="page-header">
							<h2 class="pageheader-title">Produk & Harga II Page</h2>
							...
							<div class="page-breadcrumb">
								<nav aria-label="breadcrumb">
									<ol class="breadcrumb">
										...
										<li class="breadcrumb-item active" aria-current="page">Produk & Harga II Page</li>
									</ol>
								</nav>
							</div>
						</div>
					...
					<div class="modal-dialog modal-xl">
						<div class="modal-content">
							<div class="modal-header">
								<label class="modal-title">Tambah Produk Harga II</label>
									...
									<div class="row">
										...
										<div class="col-sm-12">
											<div class="form-group">
												...
												<input type="text" class="form-control" name="status_produk" placeholder="Status..." required="required">
												<select class="form-control" name="status_produk" required="required">
					...
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
						<div class="card">
							<div class="card-header">
								<button class="btn bg-primary btn-flat" data-toggle="modal" data-target="#modal-add" title="Tambah Produk Harga"><i class="nav-icon far fa-plus-square"></i> Tambah Produk Harga
								</button>
							</div>
							<div class="card-body">
								<div class="table-responsive">
									<table id="example" class="table table-striped table-bordered second" style="width:100%">
										...
										<tbody>
											...
											$result = mysqli_query($con,"SELECT * FROM tb_produk ORDER BY id DESC");
											...
											?>
													<td><?= $row['status_produk'] == 1 ? 'List 1' : $row['status_produk'] == 2 ? 'List 2' : ($row['status_produk'] == 3 ? 'List 3' : 'Artikel' )?></td>
											<?php
																	...
																	<div class="row">
																		...
																		<div class="col-sm-12">
																			<div class="form-group">
																				...
																				<input type="text" class="form-control" name="status_produk" placeholder="Status..." required="required">
																				<select class="form-control" name="status_produk" required="required">
																					<option value="<?php echo $row['status_produk']; ?>"><?php echo $row['status_produk']; ?></option>
																					<option value="">-- Pilih Status Produk --</option>
																					<option value="1">1</option>
																					<option value="2">2</option>
																					<option value="3">3</option>
