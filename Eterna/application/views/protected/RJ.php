...
<body>
	...
	<div id="page-container" class="fade in page-sidebar-fixed page-header-fixed">
		<div id="content" class="content">
			...
			<h1 class="page-header">Pelayanan Medis - Instalasi Rawat Jalan</h1>
			<hr>
			<!-- MODAL ADD -->
				...
				<div class="modal-dialog modal-xl">
					<div class="modal-content">
						<div class="modal-header">
							<label class="modal-title">Add Profile Instalasi Rawat Jalan</label>
						...
						<form method="POST" action="<?php echo base_url() ?>index.php/AdminPelayananMedis/createrj" enctype="multipart/form-data">
							<div class="modal-body">
								<div class="row">	
									...
									<div class="col-sm-12">
										<div class="form-group">
											<label>Gambar Instalasi Rawat Jalan<font style="color: red">*</font></label>
									...
									<div class="col-sm-12">
										<div class="form-group">
											<label>Isi Content Instalasi Rawat Jalan<font style="color: red">*</font></label>
											<textarea class="ckeditor" id="ckedtor" name="isi_rj" placeholder="Isi Content Instalasi Rawat Jalan..."></textarea>
										</div>
									</div>
								</div>
							</div>
				...
				<div class="col-xl-12">
					<div class="panel panel-inverse">
						<div class="panel-heading">
							<h4 class="panel-title">Table - Instalasi Rawat Jalan</h4>
							<button class="btn bg-info btn-flat" data-toggle="modal" data-target="#modal-add" title="Tambah Agenda Rapat"><i class="nav-icon far fa-plus-square"></i> Add Profile Instalasi Rawat Jalan
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
										...
										while($row = mysqli_fetch_array($result))
										{
											...
											<div class="modal fade" id="detail<?php echo $row['id'];?>" role="dialog">
												<div class="modal-dialog modal-xl">
													<div class="modal-content">
														<div class="modal-header">
															<label class="modal-title">Details Instalasi Rawat Jalan</label>
															<button type="button" class="close" data-dismiss="modal" aria-label="Close">
																<span aria-hidden="true">&times;</span>
															</button>
														</div>
														<div class="modal-body">
															<div class="row">
																<div class="col-sm-12">
																	<div align="center">
																		<h5>Gambar Instalasi Rawat Jalan</h5>
																		<hr>
																		<?php
																		if ($row['link_rj']==NULL) { ?>
																			<h6><font style="color: red"><b><i>Anda belum mengupload Gambar Instalasi Rawat Jalan</i></b></font></h6>
																		<?php }else{ ?>
													...
													<div class="modal-content">
														...
														<div class="modal-body">
															<div class="row">
																...
																<div class="col-sm-12">
																	<div class="form-group">
																		<label>Gambar Instalasi Rawat Jalan</label>
											...
											<div class="modal fade" id="isi<?php echo $row['id'];?>" role="dialog">
												<div class="modal-dialog modal-xl">
													<div class="modal-content">
														<div class="modal-header">
															<label class="modal-title">Update Isi Instalasi Rawat Jalan</label>
															<button type="button" class="close" data-dismiss="modal" aria-label="Close">
																<span aria-hidden="true">&times;</span>
															</button>
														</div>
