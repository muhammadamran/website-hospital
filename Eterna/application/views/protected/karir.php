	...
	<div id="page-container" class="fade in page-sidebar-fixed page-header-fixed">
		<div id="content" class="content">
			<ol class="breadcrumb float-xl-right">
				...
				<li class="breadcrumb-item"><a href="javascript:;">Karir</a></li>
			</ol>
			<h1 class="page-header">Karir</h1>
			<hr>
			<!-- MODAL ADD -->
				...
				<div class="modal-dialog modal-xl">
					<div class="modal-content">
						<div class="modal-header">
							<label class="modal-title">Add Karir</label>
							<button type="button" class="close" data-dismiss="modal" aria-label="Close">
								<span aria-hidden="true">&times;</span>
							</button>
						</div>
						<form method="POST" action="<?php echo base_url() ?>index.php/AdminKarir/create" enctype="multipart/form-data">
							<div class="modal-body">
								<div class="row">	
									<div class="col-sm-12">
										<div class="form-group">
											<label>Code</label>
											<input type="text" class="form-control" name="kode" value="KARIR<?php echo date('YmdHis') ?>" readonly="readonly">
											<input type="hidden" class="form-control" name="user_id" value="<?php echo $this->session->userdata("user_id"); ?>" readonly="readonly">
											<input type="hidden" class="form-control" name="admin_name" value="Admin" readonly="readonly">
									...
									<div class="col-sm-12">
										<div class="form-group">
											...
											<input type="file" class="form-control" name="link_karir">
										</div>
									</div>	
									<div class="col-sm-12">
										<div class="form-group">
											<label>Judul<font style="color: red">*</font></label>
											<input type="text" class="form-control" name="judul_karir" placeholder="Judul..." required="required">
										</div>
									</div>
									<div class="col-sm-12">
										<div class="form-group">
											<label>Isi Content Karir<font style="color: red">*</font></label>
											<textarea class="ckeditor" id="ckedtor" name="isi_karir" placeholder="Isi Content Karir..."></textarea>
										</div>
									</div>	
									<div class="col-sm-12">
										<div class="form-group">
											<label>Tanggal Publish</label>
											<input type="date" class="form-control" name="created_date" value="<?php echo date('Y-m-d') ?>" readonly>
										</div>
									</div>	
									<div class="col-sm-12">
										<div class="form-group">
											<label>Tanggal Akhir Publish<font style="color: red">*</font></label>
				...
				<div class="col-xl-12">
					<div class="panel panel-inverse">
						<div class="panel-heading">
							<h4 class="panel-title">Table - Karir</h4>
							<button class="btn bg-info btn-flat" data-toggle="modal" data-target="#modal-add" title="Tambah Agenda Rapat"><i class="nav-icon far fa-plus-square"></i> Add Profile Karir
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
						...
						<div class="panel-body">
							<table id="data-table-buttons" class="table table-striped table-bordered table-td-valign-middle">
								...
								<tbody>
									...
									$result = mysqli_query($con,"SELECT * FROM tb_karir WHERE berkas IS NULL ORDER BY id DESC");
										...
										while($row = mysqli_fetch_array($result))
										{
											...
											<div class="modal fade" id="detail<?php echo $row['id'];?>" role="dialog">
												<div class="modal-dialog modal-xl">
													<div class="modal-content">
														<div class="modal-header">
															<label class="modal-title">Details Karir</label>
															<button type="button" class="close" data-dismiss="modal" aria-label="Close">
																<span aria-hidden="true">&times;</span>
															</button>
														</div>
														<div class="modal-body">
															<div class="row">
																<div class="col-sm-12">
																	<div align="center">
																		...
																		if ($row['link_karir']==NULL) { ?>
																			<img src="<?php echo base_url('assets/images/karir/apply.jpg')?>" class="lingkaran3" alt="User profile picture">  
																		<?php }else{ ?>
																			<img src="<?php echo base_url().'assets/images/karir/'. $row['link_karir'];?>" class="lingkaran3" alt="User profile picture">   
																		<?php } ?>
																	</div>
																</div>
																<hr>
																<div class="col-sm-12">
																	<div class="form-group">
																		<label>Judul</label>
																		<input type="text" class="form-control" name="judul_karir" value="<?php echo $row['judul_karir']; ?>">
																	</div>
																</div>
																<div class="col-sm-12">
																	<div class="form-group">
																		<label>Isi Content Karir</label>
																		<textarea class="ckeditor" id="ckedtor" name="isi_karir" placeholder="Isi Content Karir..."><?php echo $row['isi_karir']; ?></textarea>
																	</div>
																</div>	
																<div class="col-sm-12">
																	<div class="form-group">
																		<label>Tanggal Publish</label>
																		<input type="date" class="form-control" name="created_date" value="<?php echo $row['created_date']; ?>" readonly>
																	</div>
																</div>	
																<div class="col-sm-12">
																	<div class="form-group">
																		<label>Tanggal Akhir Publish</label>
											...
											<div class="modal fade" id="gambar<?php echo $row['id'];?>" role="dialog">
												<div class="modal-dialog modal-xl">
													<div class="modal-content">
														...
														<?php echo form_open_multipart(site_url('AdminKarir/updategambar/'.$row['id']));?>
														<div class="modal-body">
															<div class="row">
																<div class="col-sm-12">
																	<div align="center">
																		<h5>Gambar Banner Karir</h5>
																		<hr>
																		<?php
																		if ($row['link_karir']==NULL) { ?>
																			<h6><font style="color: red"><b><i>Anda belum mengupload Gambar Banner Karir</i></b></font></h6>
																		<?php }else{ ?>
																			<img src="<?php echo base_url().'assets/images/karir/'. $row['link_karir'];?>" class="lingkaran3" alt="User profile picture">   
																		<?php } ?>
																	</div>
																...
																<div class="col-sm-12">
																	<div class="form-group">
																		<label>Gambar Banner Karir</label>
																		<input type="file" class="form-control" name="link_karir" value="<?php echo $row['link_karir'];?>">
																		<input type="hidden" class="form-control" name="id" value="<?php echo $row['id'];?>">
																	</div>
																</div>
															</div>
															<div class="form-group">
																<button type="submit" name="updategambar" class="btn btn-block btn-primary">Update</button>
																<button type="button" class="btn btn-block btn-warning" data-dismiss="modal">Close</button>
															</div>
														</div>
													</form>
											...
											<div class="modal fade" id="isi<?php echo $row['id'];?>" role="dialog">
												<div class="modal-dialog modal-xl">
													<div class="modal-content">
														<div class="modal-header">
															<label class="modal-title">Update Isi Karir</label>
															<button type="button" class="close" data-dismiss="modal" aria-label="Close">
																<span aria-hidden="true">&times;</span>
															</button>
														</div>
														<?php echo form_open_multipart(site_url('AdminKarir/updateisi/'.$row['id']));?>
														<div class="modal-body">
															<div class="row">
																<div class="col-sm-12">
																	<div class="form-group">
															...
															<div class="form-group">
																<button type="submit" name="updateisi" class="btn btn-block btn-primary">Update</button>
																<button type="button" class="btn btn-block btn-warning" data-dismiss="modal">Close</button>
															</div>
														</div>
													</form>
											...
											<div class="modal fade" id="delete<?php echo $row['id'];?>" role="dialog">
												<div class="modal-dialog">
													<div class="modal-content">
														...
														<div class="modal-body">
															<?php echo form_open_multipart(site_url('AdminKarir/delete/'.$row['id'])); ?>
															<div class="form-group">
											...
											<div class="modal fade" id="hidden<?php echo $row['id'];?>" role="dialog">
												<div class="modal-dialog modal-xl">
													<div class="modal-content">
														...
														<?php echo form_open_multipart(site_url('AdminKarir/updatehidden/'.$row['id']));?>
														<div class="modal-body">
															<div class="row">
																<div class="col-sm-12">
																	<div class="form-group">
											...
											<div class="modal fade" id="show<?php echo $row['id'];?>" role="dialog">
												<div class="modal-dialog modal-xl">
													<div class="modal-content">
														...
														<?php echo form_open_multipart(site_url('AdminKarir/updateshow/'.$row['id']));?>
														<div class="modal-body">
															<div class="row">
																<div class="col-sm-12">
																	<div class="form-group">
