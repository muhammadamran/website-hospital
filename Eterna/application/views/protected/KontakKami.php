...
<body>
	...
	<div id="page-container" class="fade in page-sidebar-fixed page-header-fixed">
		<div id="content" class="content">
			...
			<h1 class="page-header">Kontak - Kontak Kami</h1>
			<hr>
			<!-- MODAL ADD -->
				...
				<div class="modal-dialog modal-xl">
					<div class="modal-content">
						<div class="modal-header">
							<label class="modal-title">Add Profile Kontak Kami</label>
							<button type="button" class="close" data-dismiss="modal" aria-label="Close">
								<span aria-hidden="true">&times;</span>
							</button>
						</div>
						<form method="POST" action="<?php echo base_url() ?>index.php/AdminKontak/createkontakkami" enctype="multipart/form-data">
							<div class="modal-body">
								<div class="row">	
									<div class="col-sm-12">
										<div class="form-group">
											<label>Code</label>
											<input type="text" class="form-control" name="kode" value="KontakKami<?php echo date('YmdHis') ?>" readonly="readonly">
									...
									<div class="col-sm-12">
										<div class="form-group">
											<label>Label Kontak Kami<font style="color: red">*</font></label>
											<input type="text" class="form-control" name="label_kk" placeholder="Label Kontak Kami..." required="required">
										</div>
									</div>
									<div class="col-sm-12">
										<div class="form-group">
											<label>Isi Kontak Kami<font style="color: red">*</font></label>
											<input type="text" class="form-control" name="isi_kk" placeholder="Isi Kontak Kami..." required="required">
										</div>
									</div>
								</div>
							</div>
				...
				<div class="col-xl-12">
					<div class="panel panel-inverse">
						<div class="panel-heading">
							<h4 class="panel-title">Table - Kontak Kami</h4>
							<button class="btn bg-info btn-flat" data-toggle="modal" data-target="#modal-add" title="Tambah Konta kKami"><i class="nav-icon far fa-plus-square"></i> Add Profile Kontak Kami
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
						...
						<div class="panel-body">
							<table id="data-table-buttons" class="table table-striped table-bordered table-td-valign-middle">
								...
								<tbody>
									...
									$result = mysqli_query($con,"SELECT * FROM tb_kontakkami WHERE berkas IS NULL ORDER BY id DESC");
										...
										while($row = mysqli_fetch_array($result))
										{
											...
											<div class="modal fade" id="detail<?php echo $row['id'];?>" role="dialog">
												<div class="modal-dialog modal-xl">
													<div class="modal-content">
														<div class="modal-header">
															<label class="modal-title">Details Kontak Kami</label>
															<button type="button" class="close" data-dismiss="modal" aria-label="Close">
																<span aria-hidden="true">&times;</span>
															</button>
														</div>
														<div class="modal-body">
															<div class="row">
																<div class="col-sm-12">
																	<div class="form-group">
																		<label>Label Kontak Kami</label>
																		<input type="text" class="form-control" name="label_kk" placeholder="Label Kontak Kami..." value="<?php echo $row['label_kk'];?>">
																	</div>
																</div>
																<div class="col-sm-12">
																	<div class="form-group">
																		<label>Isi Kontak Kami</label>
																		<input type="text" class="form-control" name="isi_kk" placeholder="Isi Kontak Kami..." value="<?php echo $row['isi_kk'];?>">
																	</div>
																</div>
															</div>
															<div class="form-group">
											...
											<div class="modal fade" id="isi<?php echo $row['id'];?>" role="dialog">
												<div class="modal-dialog modal-xl">
													<div class="modal-content">
														<div class="modal-header">
															<label class="modal-title">Update Isi Kontak Kami</label>
															<button type="button" class="close" data-dismiss="modal" aria-label="Close">
																<span aria-hidden="true">&times;</span>
															</button>
														</div>
														<?php echo form_open_multipart(site_url('AdminKontak/updateisikontakkami/'.$row['id']));?>
														<div class="modal-body">
															<div class="row">
																<div class="col-sm-12">
																	<div class="form-group">
															...
															<div class="form-group">
																<button type="submit" name="updateisikontakkami" class="btn btn-block btn-primary">Update</button>
																<button type="button" class="btn btn-block btn-warning" data-dismiss="modal">Close</button>
															</div>
														</div>
													</form>
											...
											<div class="modal fade" id="delete<?php echo $row['id'];?>" role="dialog">
												<div class="modal-dialog">
													<div class="modal-content">
														...
														<div class="modal-body">
															<?php echo form_open_multipart(site_url('AdminKontak/deletekontakkami/'.$row['id'])); ?>
															<div class="form-group">
															...
															<button type="submit" name="deletekontakkami" class="btn btn-danger btn-block btn-flat">Yes
															</button>
											...
											<div class="modal fade" id="hidden<?php echo $row['id'];?>" role="dialog">
												<div class="modal-dialog modal-xl">
													<div class="modal-content">
														...
														<?php echo form_open_multipart(site_url('AdminKontak/updatehiddenkontakkami/'.$row['id']));?>
														<div class="modal-body">
															<div class="row">
																<div class="col-sm-12">
																	<div class="form-group">
															...
															<div class="form-group">
																<button type="submit" name="updatehiddenkontakkami" class="btn btn-block btn-primary">Yes</button>
											...
											<div class="modal fade" id="show<?php echo $row['id'];?>" role="dialog">
												<div class="modal-dialog modal-xl">
													<div class="modal-content">
														...
														<?php echo form_open_multipart(site_url('AdminKontak/updateshowkontakkami/'.$row['id']));?>
														<div class="modal-body">
															<div class="row">
																<div class="col-sm-12">
																	<div class="form-group">
															...
															<div class="form-group">
																<button type="submit" name="updateshowkontakkami" class="btn btn-block btn-primary">Yes</button>
																<button type="button" class="btn btn-block btn-warning" data-dismiss="modal">No</button>
															</div>
														</div>
													</form>
