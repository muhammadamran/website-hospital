...
<body>
	...
	<div id="page-container" class="fade in page-sidebar-fixed page-header-fixed">
		<div id="content" class="content">
			...
			<h1 class="page-header">Pelayanan Medis - Administrasi Rawat Inap</h1>
			<hr>
			<!-- MODAL ADD -->
				...
				<div class="modal-dialog modal-xl">
					<div class="modal-content">
						<div class="modal-header">
							<label class="modal-title">Add Administrasi Rawat Inap</label>
						...
						<form method="POST" action="<?php echo base_url() ?>index.php/AdminPelayananMedis/createadmri" enctype="multipart/form-data">
							<div class="modal-body">
								<div class="row">	
									...
									<div class="col-sm-12">
										<div class="form-group">
											<label>Gambar Administrasi Rawat Inap</label>
											<input type="file" class="form-control" name="link_admri">
										</div>
									</div>	
									<div class="col-sm-12">
										<div class="form-group">
											<label>Isi Content Administrasi Rawat Inap</label>
											<textarea class="ckeditor" id="ckedtor" name="isi_admri" placeholder="Isi Content Administrasi Rawat Inap..."></textarea>
										</div>
									</div>
								</div>
							</div>
				...
				<div class="col-xl-12">
					<div class="panel panel-inverse">
						<div class="panel-heading">
							<h4 class="panel-title">Table - Administrasi Rawat Inap</h4>
							<button class="btn bg-info btn-flat" data-toggle="modal" data-target="#modal-add" title="Tambah Agenda Rapat"><i class="nav-icon far fa-plus-square"></i> Add Administrasi Rawat Inap
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
										...
										while($row = mysqli_fetch_array($result))
										{
											...
											<div class="modal fade" id="detail<?php echo $row['id'];?>" role="dialog">
												<div class="modal-dialog modal-xl">
													<div class="modal-content">
														<div class="modal-header">
															<label class="modal-title">Details Administrasi Rawat Inap</label>
															<button type="button" class="close" data-dismiss="modal" aria-label="Close">
																<span aria-hidden="true">&times;</span>
															</button>
														</div>
														<div class="modal-body">
															<div class="row">
																<div class="col-sm-12">
																	<div align="center">
																		<h5>Gambar Administrasi Rawat Inap</h5>
																		<hr>
																		<?php
																		if ($row['link_admri']==NULL) { ?>
																			<h6><font style="color: red"><b><i>Anda belum mengupload Gambar Administrasi Rawat Inap</i></b></font></h6>
																		<?php }else{ ?>
											...
											<div class="modal fade" id="isi<?php echo $row['id'];?>" role="dialog">
												<div class="modal-dialog modal-xl">
													<div class="modal-content">
														<div class="modal-header">
															<label class="modal-title">Update Isi Administrasi Rawat Inap</label>
															<button type="button" class="close" data-dismiss="modal" aria-label="Close">
																<span aria-hidden="true">&times;</span>
															</button>
														</div>
