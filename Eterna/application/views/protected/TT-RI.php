...
<body>
	...
	<div id="page-container" class="fade in page-sidebar-fixed page-header-fixed">
		<div id="content" class="content">
			...
			<h1 class="page-header">Pelayanan Medis - Tata Tertib Rawat Inap</h1>
			<hr>
			<!-- MODAL ADD -->
				...
				<div class="modal-dialog modal-xl">
					<div class="modal-content">
						<div class="modal-header">
							<label class="modal-title">Add Tata Tertib Rawat Inap</label>
							<button type="button" class="close" data-dismiss="modal" aria-label="Close">
								<span aria-hidden="true">&times;</span>
							</button>
						</div>
						<form method="POST" action="<?php echo base_url() ?>index.php/AdminPelayananMedis/createttri" enctype="multipart/form-data">
							<div class="modal-body">
								<div class="row">	
									<div class="col-sm-12">
										<div class="form-group">
											<label>Code</label>
											<input type="text" class="form-control" name="kode" value="TT-RI<?php echo date('YmdHis') ?>" readonly="readonly">
									...
									<div class="col-sm-12">
										<div class="form-group">
											<label>Gambar Tata Tertib Rawat Inap</label>
											<input type="file" class="form-control" name="link_ttri">
										</div>
									</div>	
									<div class="col-sm-12">
										<div class="form-group">
											<label>Isi Content Tata Tertib Rawat Inap</label>
											<textarea class="ckeditor" id="ckedtor" name="isi_ttri" placeholder="Isi Content Tata Tertib Rawat Inap..."></textarea>
										</div>
									</div>
								</div>
							</div>
				...
				<div class="col-xl-12">
					<div class="panel panel-inverse">
						<div class="panel-heading">
							<h4 class="panel-title">Table - Tata Tertib Rawat Inap</h4>
							<button class="btn bg-info btn-flat" data-toggle="modal" data-target="#modal-add" title="Tambah Agenda Rapat"><i class="nav-icon far fa-plus-square"></i> Add Tata Tertib Rawat Inap
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
						...
						<div class="panel-body">
							<table id="data-table-buttons" class="table table-striped table-bordered table-td-valign-middle">
								...
								<tbody>
									...
									$result = mysqli_query($con,"SELECT * FROM tb_ttri WHERE berkas IS NULL ORDER BY id DESC");
										...
										while($row = mysqli_fetch_array($result))
										{
											...
											<div class="modal fade" id="detail<?php echo $row['id'];?>" role="dialog">
												<div class="modal-dialog modal-xl">
													<div class="modal-content">
														<div class="modal-header">
															<label class="modal-title">Details Tata Tertib Rawat Inap</label>
															<button type="button" class="close" data-dismiss="modal" aria-label="Close">
																<span aria-hidden="true">&times;</span>
															</button>
														</div>
														<div class="modal-body">
															<div class="row">
																<div class="col-sm-12">
																	<div align="center">
																		<h5>Gambar Tata Tertib Rawat Inap</h5>
																		<hr>
																		<?php
																		if ($row['link_ttri']==NULL) { ?>
																			<h6><font style="color: red"><b><i>Anda belum mengupload Gambar Tata Tertib Rawat Inap</i></b></font></h6>
																		<?php }else{ ?>
																			<img src="<?php echo base_url().'assets/images/rumah-sakit/rawat-inap/tata-tertib/'. $row['link_ttri'];?>" class="lingkaran3" alt="User profile picture">   
																		<?php } ?>
																	</div>
																</div>
																<hr>
																<div class="col-sm-12">
																	<div class="form-group">
																		<label>Isi</label>
																		<textarea class="ckeditor" id="ckedtor" name="isi_ttri" placeholder="Isi..."><?php echo $row['isi_ttri'];?></textarea>
																	</div>
																</div>
															</div>
															<div class="form-group">
											...
											<div class="modal fade" id="gambar<?php echo $row['id'];?>" role="dialog">
												<div class="modal-dialog modal-xl">
													<div class="modal-content">
														...
														<?php echo form_open_multipart(site_url('AdminPelayananMedis/updategambarttri/'.$row['id']));?>
														<div class="modal-body">
															<div class="row">
																<div class="col-sm-12">
																	<div align="center">
																...
																<div class="col-sm-12">
																	<div class="form-group">
																		<label>Gambar Tata Tertib Rawat Inap</label>
																		<input type="file" class="form-control" name="link_ttri" value="<?php echo $row['link_ttri'];?>">
																		<input type="hidden" class="form-control" name="id" value="<?php echo $row['id'];?>">
																	</div>
																</div>
															</div>
															<div class="form-group">
																<button type="submit" name="updategambarttri" class="btn btn-block btn-primary">Update</button>
																<button type="button" class="btn btn-block btn-warning" data-dismiss="modal">Close</button>
															</div>
														</div>
													</form>
											...
											<div class="modal fade" id="isi<?php echo $row['id'];?>" role="dialog">
												<div class="modal-dialog modal-xl">
													<div class="modal-content">
														<div class="modal-header">
															<label class="modal-title">Update Isi Tata Tertib Rawat Inap</label>
															<button type="button" class="close" data-dismiss="modal" aria-label="Close">
																<span aria-hidden="true">&times;</span>
															</button>
														</div>
														<?php echo form_open_multipart(site_url('AdminPelayananMedis/updateisittri/'.$row['id']));?>
														<div class="modal-body">
															<div class="row">
																<div class="col-sm-12">
																	<div class="form-group">
															...
															<div class="form-group">
																<button type="submit" name="updateisittri" class="btn btn-block btn-primary">Update</button>
																<button type="button" class="btn btn-block btn-warning" data-dismiss="modal">Close</button>
															</div>
														</div>
													</form>
											...
											<div class="modal fade" id="delete<?php echo $row['id'];?>" role="dialog">
												<div class="modal-dialog">
													<div class="modal-content">
														...
														<div class="modal-body">
															<?php echo form_open_multipart(site_url('AdminPelayananMedis/deletettri/'.$row['id'])); ?>
															<div class="form-group">
															...
															<button type="submit" name="deletettri" class="btn btn-danger btn-block btn-flat">Yes
															</button>
											...
											<div class="modal fade" id="hidden<?php echo $row['id'];?>" role="dialog">
												<div class="modal-dialog modal-xl">
													<div class="modal-content">
														...
														<?php echo form_open_multipart(site_url('AdminPelayananMedis/updatehiddenttri/'.$row['id']));?>
														<div class="modal-body">
															<div class="row">
																<div class="col-sm-12">
																	<div class="form-group">
															...
															<div class="form-group">
																<button type="submit" name="updatehiddenttri" class="btn btn-block btn-primary">Yes</button>
											...
											<div class="modal fade" id="show<?php echo $row['id'];?>" role="dialog">
												<div class="modal-dialog modal-xl">
													<div class="modal-content">
														...
														<?php echo form_open_multipart(site_url('AdminPelayananMedis/updateshowttri/'.$row['id']));?>
														<div class="modal-body">
															<div class="row">
																<div class="col-sm-12">
																	<div class="form-group">
															...
															<div class="form-group">
																<button type="submit" name="updateshowttri" class="btn btn-block btn-primary">Yes</button>
																<button type="button" class="btn btn-block btn-warning" data-dismiss="modal">No</button>
															</div>
														</div>
													</form>
